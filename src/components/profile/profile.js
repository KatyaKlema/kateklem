        ...
        return (
            <main>
                ...
                <div className="wrapper">
                    <div className="wrapper__links" id="social">
                        ...
                        <a className="social-link social-link--linkedin" id="linkedin" href="https://www.linkedin.com/mwlite/in/ekaterina-klementeva-296b87168">
                            <svg className="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                <title>
                                    linkedin
                                </title>
                                <g className="social-group" fill="none" fill-rule="evenodd">
                                    <circle className="social-group__outline" stroke="#000" stroke-width="20" cx="300"
                                            cy="300" r="262.5"/>
                                    <circle className="social-group__inner-circle" fill="#2D76B0" cx="300" cy="300"
                                            r="252.5"/>
                                    <path className="social-group__icon"
                        ...
                        <a className="social-link social-link--instagram" id="instagram" href="https://www.instagram.com/katyaklema/?hl=ru">
                            <svg className="social-svg" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                <title>
                                    instagram
                                </title>
                                ...
                                <g className="social-group" fill="none" fill-rule="evenodd">
                                    <circle className="social-group__outline" stroke="#000" stroke-width="20" cx="300"
                                            cy="300" r="262.5"/>
                                    <circle className="social-group__inner-circle social-group__inner-circle--instagram"
                                            fill="url(#simpleInsta)" cx="300" cy="300"
                                            r="252.5"/>
                                    <path className="social-group__icon"
